// RED A8 context loader v1.7 — conversational voice + structured avatar micro-actions.
(function(){
  const V='1.7.0';
  ...
  window.REDContext={version:V,systemPrompt:compactSystemPrompt,serverMessages,serverIdentityContext,compactMemory,bodyProtocol,limits:{directRecent:RECENT_CHAT,serverRecent:SERVER_CHAT,visionRecent:VISION_CHAT}};
})();