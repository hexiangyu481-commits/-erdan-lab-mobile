...
(function(){
  const V='1.1.0', POSE='pose_02_chin_rest';
...
`;document.head.appendChild(s);
  ...
  window.REDLive02={version:V,apply,blink:()=>trigger(performance.now(),false),gaze:(x=0,y=0)=>{gtx=clamp(Number(x)||0,-1,1);gty=clamp(Number(y)||0,-1,1);nextGaze=performance.now()+1200}};
})();