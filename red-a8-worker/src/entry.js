...
export default {
  async fetch(req,env,ctx){
    ...
    if(url.pathname==="/health")return j({ok:true,name:"red-a8-mind",version:9,push:true,chatRecovery:true,wakeTrace:true,proactiveFollowUp:true,adultDesire:true,time:Date.now()},200,env);
