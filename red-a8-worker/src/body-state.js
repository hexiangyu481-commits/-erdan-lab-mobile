...
function stable(a){if(!a)return'';const x=norm(a);return JSON.stringify({pose:x.pose,gaze:x.gaze,expression:x.expression,hand:x.hand,proximity:x.proximity,motion:x.motion,durationMs:x.durationMs})}
